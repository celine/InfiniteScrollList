...
public final class MyDateTypeAdapter extends TypeAdapter<Date> {
    ...
    private static DateFormat buildNSDateFormat() {
        DateFormat nsFormat = new SimpleDateFormat("yyyy'-'MM'-'dd'T'HH':'mm':'ss.SSS'Z'", Locale.US);
        nsFormat.setTimeZone(TimeZone.getTimeZone("UTC"));
        return nsFormat;
    }
    ...
    private final DateFormat nsdDateFormat = buildNSDateFormat();
